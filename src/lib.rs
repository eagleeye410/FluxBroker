...
#[derive(Debug)]
pub struct FluxBrokerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FluxBrokerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FluxBroker processing");
    
    let mut processor = FluxBrokerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FluxBrokerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FluxBrokerProcessor::new(false);
